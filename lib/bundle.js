...
class Builder extends EventEmitter {
  ...
  _get_dependency_tree (filename, callback) {
    walker({
      allowCyclic: true,
...
_resolve_module_dependencies (id, mod) {
  var self = this
  var pkg = this.pkg
  var cwd = this.cwd
...
_resolve_dependencies (id, mod, deps, resolved) {
  var module_name
  var r
  var real
  var not_installed = []
